#!/usr/bin/env python3
"""
Islands of Myth - Tutorial Walker v2
Carefully follows the guided tour step by step.
Detects exact prompt text and sends correct responses.
"""
...
OUTPUT_FILE = "/root/.openclaw/workspace/mud/iom_tutorial_walk.txt"

with open(OUTPUT_FILE, 'w') as f:
    f.write("# Islands of Myth — Tutorial Walk-Through\n# " + time.strftime("%Y-%m-%d %H:%M:%S") + "\n\n")
