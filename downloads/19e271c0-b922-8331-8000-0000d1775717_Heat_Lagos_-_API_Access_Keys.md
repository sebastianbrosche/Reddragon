...
API access: [PENDING, Sarah or Adam to add]
URL: [PENDING]
Key: [PENDING]
Owner: [PENDING]
Goal: Connect to Google Home / Alexa for voice commands
Research needed: Is there an open-source Google Home or Alexa API that connects to Kimi?
...
Owner: Sebastian (account holder)
Adam's access: Needs login credentials to act as "mystery shopper"
Credentials (shared with Adam for mystery shopper access):
  - Email: adriansalas124@gmail.com
  - Password: HEAT123!heat123
  - View class bookings
...
Test URL (Sarah to validate workflow):
  - https://www.youtube.com/watch?v=qcIF9ihx-rQ
  - Video: "Bicep Glue - Yoga for BJJ" with Sebastian
...
|------|-----|----------|---------|--------|
| 14 May | Miha | bsport | Added login credentials | adriansalas124@gmail.com |
| 14 May | Miha | YouTube | Added test URL for transcript validation | https://www.youtube.com/watch?v=qcIF9ihx-rQ |
...
| 14 May | Adam | Cloudflare | YTT site hosting | Active |
...
- Shelly API details (Sarah or Adam to provide) — IN PROGRESS: Sarah researched local HTTP API and Home Assistant bridge
