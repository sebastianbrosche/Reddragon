#!/usr/bin/env python3
"""
Islands of Myth - Enter the World v3
Skip sign read, go straight to enter portal.
"""
...
OUTPUT_FILE = "/root/.openclaw/workspace/mud/iom_enter_world3.txt"

with open(OUTPUT_FILE, 'w') as f:
    f.write("# Islands of Myth — Enter the World v3\n# " + time.strftime("%Y-%m-%d %H:%M:%S") + "\n\n")
...
# Just enter the portal directly - no sign reading
time.sleep(1)
tn.read_very_eager()
...
# Try to go deeper - if any direction worked, keep going
# First check if we have more than the gates room
tn.write(b'look\n')
text = read_all(tn, 1)
