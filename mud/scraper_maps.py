...
Fetches all island maps and area pages, extracts ASCII maps and room data.
"""
...
for island in ISLANDS:
    ...
    for li in island_soup.find_all("li"):
        ...
        if link and link.get("href") and ".html" in link.get("href"):
            ...
            area_url = urljoin(island_url, link.get("href"))
    ...
    for area in areas:
        ...
        # Try to find ASCII map - look for preformatted text or patterns
        ascii_map = None
        ...
        area_data = {
            ...
            "info": info_paragraphs[:5],  # First 5 info paragraphs
